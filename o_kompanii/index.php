...
<div class="blok_1"><!--начало первого блока-->
<div class="raz1_blok1"><!--начало 1 раздела 1 блока-->
<div class="zagol_1 text_40p"> <b>Немного о нас</b></div>
<div class="tex1 text_36p"> «ТехноСофт» — это команда <br> профессионалов, которая уже более 10 лет <br> помогает бизнесу работать без сбоев. Мы <br> начинали как небольшая группа <br> энтузиастов, а сегодня мы — полноценный <br> системный интегратор с офисами в трех <br>городах и штатом более 200 специалистов.</div>
</div><!--конец 1 раздела 1 блока-->

<div class="foto_dekor"></div>

</div><!--конец первого блока-->


<div class="blok_2"><!--начало второго блока-->

    <div class="roditel_kartoch"><!--родитель карточки начало-->
        <div class="zag_kart text_32p"><b>Что мы делаем?</b></div>
        <div class="tex2 text_24p">Мы внедряем, обслуживаем и <br> защищаем корпоративные <br> системы — от 1С и CRM до <br> защищённого документооборота и <br> IT-инфраструктуры «под ключ» —  <br>для предприятий любого<br>  масштаба.</div>
    </div><!--родитель карточки конец-->

<div class="roditel_kartoch"><!--родитель карточки начало-->
        <div class="zag_kart text_32p"><b>Наш подход</b></div>
        <div class="tex2 text_24p">Мы делаем технологии  <br> простыми и безопасными: <br> сотрудник получает доступ <br> к нужной системе за пару <br> кликов, а администратор <br> держит всё под контролем <br> в единой панели.</div>
    </div><!--родитель карточки конец-->

<div class="roditel_kartoch"><!--родитель карточки начало-->
        <div class="zag_kart text_32p"><b>Наши ценности</b></div>
        <div class="tex2 text_24p"> * Надежность — мы отвечаем за <br>каждый внедренный проект и <br>каждую выданную заявку. <br>
*Безопасность — защита данных <br>  является нашим приоритетом. <br>
*Скорость — мы не заставляем  <br>ждать.</div>
    </div><!--родитель карточки конец-->
</div><!--конец второго блока-->

<!--начало декора-->
<div class="kryg1 dek_kryg"></div>
<div class="kryg2 dek_kryg"></div>
<div class="kryg3 dek_kryg"></div>
<div class="kryg4 dek_kryg"></div>
